...
const Login = () => {
    return (
        <div className=" mt-10 mb-10 mr-10 ml-10">
            ...
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-[#135D66] text-gray-100">
	...
	<form noValidate="" action="" className="space-y-8">
		<div className="space-y-4">
			...
			<div className="space-y-2">
				...
				<input type="email" name="email" id="email" placeholder="Your Email" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-white text-black focus:border-violet-400" />
			</div>
		...
		<button type="button" className=" btn  w-full px-8 py-3 font-semibold rounded-md bg-white text-gray-900">Sign in</button>
	</form>
</div>
